...
/**Size props 필요 */
export const Modal: React.FC<ModalProps> = ({ size, children }) => {
  ...
  return (
    <>
      <div className="w-full h-full fixed left-0 top-0 bg-[#4c4c4c]/[0.53] z-30 flex flex-col items-center justify-center ">
        <div
