 ...
 * @returns 주식 요약
 * 마이크로소프트는 기술 회사다. 이 회사는 소프트웨어, 서비스, 디바이스, 솔루션을 개발하고 지원한다.<br>사업 부문은 Productivity & Business Process, Intelligent Cloud
 */
export const summaryApi = async (stockCode: string): Promise<string> => {
